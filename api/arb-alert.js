...
const EXCHANGES = {
    binance: {
        name: 'Binance',
        url: 'https://data-api.binance.vision/api/v3/depth?symbol=USDTBRL&limit=5',
        parseAsks: (d) => d?.asks || [],
        parseBids: (d) => d?.bids || [],
    ...
    bybit: {
        name: 'Bybit',
        url: 'https://api.bytick.com/v5/market/orderbook?category=spot&symbol=USDTBRL&limit=5',
